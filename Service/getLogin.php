...
where acc.Username='".$user."' AND acc.Password='".$password."' and (AccoutType=1 OR AccoutType=2)
and ProgramName='Web Check Status'";
...
where acc.Username='".$user."' AND acc.Password='".$password."' and (AccoutType=1 OR AccoutType=2) and ProgramName='Web Check Status'";
